...
class Compare(unittest.TestCase):
    ...
    def test_decodepoint_sum(self):
        for i in range(200):
            ...
            self.assertEqual(
                self.orig_decodepoint_sum(s), self.new_decodepoint_sum_1(s)
            )
            self.assertEqual(
                self.new_decodepoint_sum_1(s), self.new_decodepoint_sum_2(s)
            )
    ...
    def test_decodepoint_2(self):
        for i in range(200):
            ...
            self.assertEqual(self.orig_decodepoint_2(P_s), self.new_decodepoint_2(P_s))
    ...
    def test_decodeint(self):
        for i in range(200):
            s = H(str(i).encode("ascii"))[:32]
            self.assertEqual(self.orig_decodeint(s), self.new_decodeint(s))
    ...
    def test_signature_sum(self):
        for i in range(200):
            ...
            self.assertEqual(self.orig_signature_sum(sk), self.new_signature_sum(sk))
    ...
    def test_encodeint(self):
        for i in range(200):
            ...
            self.assertEqual(self.orig_encodeint(sint), self.new_encodeint(sint))
