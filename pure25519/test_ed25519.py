...
class Basic(unittest.TestCase):
    ...
    def test_raw(self):
        ...
        exp_vks = unhexlify(
            "3b6a27bcceb6a42d62a3a8d02a6f0d73" "653215771de243a63ac048a18b59da29"
        )
        ...
        exp_sig = unhexlify(
            "b0b47780f096ae60bfff8d8e7b19c36b"
        ...
        self.assertRaises(raw.BadSignatureError, raw.open, sig + msg + b".. NOT!", vk_s)
        self.assertRaises(raw.BadSignatureError, raw.open, sig + flip_bit(msg), vk_s)
        self.assertRaises(raw.BadSignatureError, raw.open, sig + msg, flip_bit(vk_s))
        self.assertRaises(
            raw.BadSignatureError, raw.open, sig + msg, flip_bit(vk_s, in_byte=2)
        )
        self.assertRaises(raw.BadSignatureError, raw.open, flip_bit(sig) + msg, vk_s)
        self.assertRaises(
            raw.BadSignatureError, raw.open, flip_bit(sig, in_byte=33) + msg, vk_s
        )
    ...
    def test_keypair(self):
        ...
        self.assertEqual(
            sk1.to_ascii(encoding="base64"), sk2.to_ascii(encoding="base64")
        )
        self.assertEqual(
            vk1.to_ascii(encoding="base64"), vk2.to_ascii(encoding="base64")
        )

    def test_publickey(self):
        seed = unhexlify(
            "4ba96b0b5303328c7405220598a587c4" "acb06ed9a9601d149f85400195f1ec3d"
        )
        ...
        self.assertEqual(
            hexlify(sk.to_seed()),
            (b"4ba96b0b5303328c7405220598a587c4" b"acb06ed9a9601d149f85400195f1ec3d"),
        )
    ...
    def test_OOP(self):
        ...
        exp_vks = unhexlify(
            "a66d161e090652b054740748f059f92a" "5b731f1c27b05571f6d942e4f8b7b264"
        )
        ...
        self.assertRaises(ed25519.BadSignatureError, vk.verify, sig, msg + b".. NOT!")

    def test_object_identity(self):
        sk1_s = unhexlify(
            "ef32972ae3f1252a5aa1395347ea008c"
            "bd2fed0773a4ea45e2d2d06c8cf8fbd4"
            "c024601a9c5b854fb100ff3116cf4f22"
            "a311565f027391cb49d3bbe11c44399d"
        )
        sk2_s = unhexlify(
            "3d550c158900b4c2922b6656d2f80572"
    ...
    def test_prefix(self):
        ...
        self.assertRaises(
            ed25519.BadPrefixError, ed25519.SigningKey, p, prefix=b"WRONG-"
        )
        ...
        self.assertRaises(
            ed25519.BadPrefixError, ed25519.VerifyingKey, p, prefix=b"WRONG-"
        )
        ...
        self.assertRaises(
            ed25519.BadPrefixError, vk1.verify, p, b"msg", prefix=b"WRONG-"
        )
    ...
    def test_encoding(self):
        ...
        check1(
            "base32", b"private0-rceirceirceirceirceirceirceirceirceirceirceirceircea"
        )
        check1(
            "hex",
        ...
        check2(
            "base32", b"public0-wjer3ficvyuggcrlvszobr2fcd743uziym2p6pqtsptvwljr47oa"
        )
        check2(
            "hex",
